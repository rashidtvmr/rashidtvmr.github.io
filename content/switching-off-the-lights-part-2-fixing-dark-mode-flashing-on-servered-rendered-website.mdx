...
In the example featured in the [first blog post](https://rashidtvmr.com/posts/switching-off-the-lights-adding-dark-mode-to-your-react-app-with-context-and-hooks-f41da6e07269#theme-provider) this is what the function looked like:
