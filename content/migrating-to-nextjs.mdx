...
I wrote extensively about my SEO-related mistakes and incidents in [SEO mistakes I've made and how I fixed them](https://rashidtvmr.com/posts/seo-mistakes-i-have-made-and-how-i-fixed-them/) in case you want to read scary SEO stories 👻
...
I wrote about one of those performance issues: my overreliance on `iframes` for Twitter Embeds which I solved by [building my own "Static Tweet" component](https://rashidtvmr.com/posts/static-tweets-with-mdx-nextjs/).
