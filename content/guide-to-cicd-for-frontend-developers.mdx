...
- **[ESlint](https://eslint.org/)** for linting, it comes with a set of rules to write proper Javascript, and these rules can be customized to your own team's fit. Additionally, should you need something more specific, you can build your own ESLint rules, [I wrote about it here](https://rashidtvmr.com/posts/how-to-build-first-eslint-rule), it's an interesting exercise that involves Abstract Syntax Tree (AST).
...
If you're curious about cross-browser testing, [I wrote a blog post about it earlier this year](https://rashidtvmr.com/posts/running-cross-browser-cypress-github-ci) showcasing a very simple setup!
